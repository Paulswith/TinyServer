...
//        ts_bodyEditWidget->setObjectName(QStringLiteral("ts_bodyEditWidget"));
    ...
    void retranslateUi(QMainWindow *TSMainWindow)
    {
        ...
        ts_startListen->setText(QApplication::translate("TSMainWindow", "start listen", nullptr));
        ts_suspendListen->setText(QApplication::translate("TSMainWindow", "suspend listen", nullptr));
